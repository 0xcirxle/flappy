...
original_image_up = pygame.image.load("img.png")
original_width, original_height = original_image_up.get_size()
bird_up = pygame.transform.scale(pygame.image.load("img.png"), 
    (original_width // 8, original_height // 8))

bird_down = pygame.transform.scale(pygame.image.load("img.png"), 
    (original_width // 8, original_height // 8))

bird_mid = pygame.transform.scale(pygame.image.load("img.png"), 
    (original_width // 8, original_height // 8))
